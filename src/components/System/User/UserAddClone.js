...
const UserAddCloneModel = ({ visible, value, onCreate, onCancel, mainLanguage, language, commonLanguage, mode }) => {
    ...
    const screenName = (mode === TNS_MODE.Create) ? language.USER_NEW_PAGE : language.USER_CLONE_PAGE;
            ...
            >
                ...
                <Tabs defaultActiveKey='1' >
                    <TabPane tab={language.USER_GENERAL_INFOR} key='1'>
                        <Row gutter={[16, 0]}>
                            <Col span={12} className={`tns-field-item ${TNS_METHOD.checkAvailableField(displayDefaultFieldOnAddCloneForm, 'User_Code')}`}>
                            ...
                            <Col span={12} className={`tns-field-item ${TNS_METHOD.checkAvailableField(displayDefaultFieldOnAddCloneForm, 'User_Name')}`}>
                            ...
                            <Col span={12} className={`tns-field-item ${TNS_METHOD.checkAvailableField(displayDefaultFieldOnAddCloneForm, 'User_Email')}`}>
                            ...
                            <Col span={12} className={`tns-field-item ${TNS_METHOD.checkAvailableField(displayDefaultFieldOnAddCloneForm, 'User_Password')}`}>
                            ...
                            <Employee_Select required={true}
                                className={`tns-field-item ${TNS_METHOD.checkAvailableField(displayDefaultFieldOnAddCloneForm, 'User_Employee')}`}
                                name='User_Employee'
                            ...
                            <Col span={12} className={`tns-field-item ${TNS_METHOD.checkAvailableField(displayDefaultFieldOnAddCloneForm, 'User_NumberPhone')}`}>
...
const UserAddClone = ({ allowAccess, actionLabel, mode, onSave, mainLanguage, value }) => {
    ...
    const onCreate = values => {
        Promise.all([User_Service.createModel(values)]).then(resultCreate => {
    ...
    return (
        <span>
            ...
            <UserAddCloneModel mainLanguage={mainLanguage}
                language={language}
