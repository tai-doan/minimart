...
import { getColumnInSearchTable, defaultColumnInResultTable, defaultFieldInSearchForm, setColumnInSearchTable, getFieldSearch, setFieldSearch, getFieldSort, setFieldSort, searchDefaultModel } from './Models/Employee.Models';
import { Employee_Search } from './EmployeeSearch';
import { EmployeeAddClone } from './EmployeeAddClone';
...
const EmployeeList = () => {
    ...
    const onSearchForm = (value, option) => {
        ...
        Promise.all([Employee_Service.searchData(value, !!option ? option : searchOption)]).then(searchResult => {
    ...
    const onDeleteConfirm = (title, content, IdList) => {
        confirm({
            ...
            onOk() {
                return Promise.all([Employee_Service.deleteModel(IdList)]).then(resultDelete => {
    ...
    return (
        <Layout style={{ padding: 20 }}>
            <Tns_Breadcum module={TNS_MODULE.COMPANY} screen={language.EMPLOYEE_SEARCH_PAGE} mainLanguage={mainLanguage} />
            <Content className='site-layout-background'>
                <Employee_Search searchField={fieldOnSearchForm}
                    value={searchModel}
                ...
                <span className='main-screen-button-area'>
                    ...
                    <EmployeeAddClone allowAccess={true}
                    ...
                    <EmployeeEditView allowAccess={true}
...
// export { EmployeeList };
export { EmployeeList as default };
